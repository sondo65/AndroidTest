...
import sondo65.com.androidtest.viewmodels.CityListViewModel;
...
public class CityListActivity extends AppCompatActivity {
    ...
    private CityListViewModel mCityListActivityViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCityListActivityViewModel = new ViewModelProvider(this).get(CityListViewModel.class);
